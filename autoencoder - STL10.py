...
(x_train, y_train), (x_test, y_test) = collect_data.STL10.load_data(collect_data.STL10(), toResize=True, dims=(96, 96))
x_train = x_train / 255
x_test = x_test / 255
...
model.add(Conv2D(32, kernel_size=3, strides=2, padding='same', activation='relu'))  # 56x56x32 24x24x32
model.add(Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu'))  # 28x28x64 12x12x64
model.add(Conv2D(64, kernel_size=3, strides=1, padding='same', activation='relu'))  # 28x28x64 12x12x64
model.add(BatchNormalization())  # 28x28x64 12x12x64
model.add(Conv2D(128, kernel_size=3, strides=2, padding='same', activation='relu'))  # 14x14x128 6x6x128
model.add(Conv2D(128, kernel_size=3, strides=1, padding='same', activation='relu'))  # 14x14x128 6x6x128
model.add(BatchNormalization())  # 14x14x128 6x6x128
model.add(Conv2D(256, kernel_size=3, strides=2, padding='same', activation='relu'))  # 7x7x256 3x3x256
model.add(Conv2D(256, kernel_size=3, strides=1, padding='same', activation='relu'))  # 7x7x256 3x3x256
model.add(BatchNormalization())  # 7x7x256 3x3x256

model.add(UpSampling2D())
model.add(Conv2D(128, kernel_size=3, strides=1, padding='same', activation='relu'))  # 32x32x32 14x14x128 6x6x128
model.add(BatchNormalization())
model.add(UpSampling2D())
model.add(Conv2D(64, kernel_size=3, strides=1, padding='same', activation='relu'))  # 32x32x32 28x28x64 12x12x64
model.add(BatchNormalization())
model.add(UpSampling2D())
model.add(Conv2D(32, kernel_size=3, strides=1, padding='same', activation='relu'))  # 32x32x32 56x56x32 24x24x32
model.add(BatchNormalization())
model.add(UpSampling2D())
model.add(Conv2D(16, kernel_size=3, strides=1, padding='same', activation='relu'))  # 32x32x32 112x112x16 48x48x16
model.add(BatchNormalization())
model.add(UpSampling2D())
model.add(Conv2D(8, kernel_size=3, strides=1, padding='same', activation='relu'))  # 32x32x32 224x224x8 96x96x8
model.add(BatchNormalization())
model.add(Conv2D(3, kernel_size=1, strides=1, padding='same', activation='sigmoid'))  # 32x32x3 224x224x3 96x96x3
